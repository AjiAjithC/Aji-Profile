   ...
   const handleSubmit = async (e) => {
      ...
      try {
         ...
         if (response.ok) {
            ...
            setFormData({ name: "", contact: "", email: "", Message: "" ,subject:""}); // Reset form
         } else {
            ...
            <div className=' max-w-[800px]  md:max-w-[1000px] lg:max-w-[1150px] xl:max-w-[1250px]  mx-auto flex flex-col p-5 '>
               ...
               <div className='mt-15 grid grid-cols-1 md:grid-cols-2 gap-5 '>
                  ...
                  <input
                     ...
                     onChange={handleChange}
                     className="border px-4 py-3 w-full mt-5 h-35 text-sm border-borderPrimary"
                  />
               ...
               {formData.name !== "" &&formData.contact !== "" &&formData.email !== "" &&
                  <div className='flex justify-center items-center mt-10'>
                     <button type="submit" onClick={handleSubmit}
                        className="col-span-1 md:col-span-2 bg-black text-white py-3 px-4 w-50 rounded-md hover:bg-blue-600">
                        Submit
                     </button>
                  </div>
               }
